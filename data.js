const data = {
  ...
  "discovery_methods": {
    ...
    "My bf mentioned to me saying \"DAVID FINALLY GOT ARRESTED\"": 1,
    "Instagram Reels @big1apple1vibes": 1,
    "I saw it on the Google Play homepage randomly as I was looking for a new app to download": 1,
    "Instagram Reels talking about the story, I then looked up an article about it to get more info": 1,
  ...
  "stories": [
    ...
    {
      "happened": "D4vid was charged with murdering and sexually abusing the minor, Celeste, and he is stating he is not guilty. The reason why the information took so long to be announced was because her body was badly decomposed.",
    ...
    {
      "happened": "NYC mayor, Mamdani, pushed a new tax on luxury second homes because of the rising wealth gap and housing costs.",
    ...
    {
      "happened": "Designer Jake Burt has been selling unique hoodies since April 2026 only in his small shop in London to create the idea of scarcity and remind people of in person shopping",
    ...
    {
      "happened": "Popular music artist, D4vid has been detained April 16th by LAPD in relation to Celeste Hernandez's death.",
    ...
    {
      "happened": "Trump made it harder for people to file taxes by killing Direct File, produced by the Biden administration, because he felt that people didn't use it and it cost a lot to maintain.",
    ...
    {
      "happened": "After man stabbed 3 people in Grand Central NYC, he was shot and killed by NYPD -- leaving Grand Central empty despite it's usual hustle and bustle.",
    ...
    {
      "happened": "Ben Riley tried to convince his father that AI was misleading him about cancer advice, but his father didn't listen because he felt the knowledge AI provided was empowering.",
    ...
    {
      "happened": "There have been many incidents where teens (\"conquesters\" and \"foamers\") have been carousing NYC trains using modded skeleton keys which are easily accessible and cheap, this is primarily due to their love of trains and their hope to steal MTA equipment.",
    ...
    {
      "happened": "KJ was born with a rare genetic disease, but CRISPR technology was able to get mRNA into his liver to save him.",
    ...
    {
      "happened": "A woman shares her experience of supporting her husband while he can't find a job and is trying to get an online masters in CS because he hopes it will open him to more opportunities, but he should really be focusing on his career and what will happen after his degree.",
    ...
    {
      "happened": "Many people's closets are a mess because they dont utilize vertical space and they don't use gadgets to help them organize.",
    ...
    {
      "happened": "Matcha is growing really popular and people claim the buzz is smoother than coffee, but experts say there's not much evidence to support this and it could just be because of a\u00a0 lower caffeine or sugar dose.",
    ...
    {
      "happened": "Shapewear works in a way that allows people to attain the body shape they want, without dieting or going to the gym, but what's underneath is the same.",
    ...
    {
      "happened": "Trump will lose the birthright citizenship case at the Supreme Court, but he has already won by changing the rules to benefit himself. Lower courts will now have less power and wont be able to have nationwide injunctions.",
    ...
    {
      "happened": "It's important to change your running shoes after 300-500miles because it can lead to an increase risk of injury.",
    ...
    {
      "happened": "Trump's new ballroom design decisions are being made very hastily because they are trying to implement them ASAP.",
    ...
    {
      "happened": "Society sees gray hair as an end of life signal and it can also harm womens' careers. Hair dye is very powerful for women but it also signifies not accepting your true age. Going grey can feel empowering and theres new techniques to help women feel more confident with grey hair.",
    ...
    {
      "happened": "Developments and cities are trying to add more restaurants and bars so they make the environment lively and exciting.",
    ...
    {
      "happened": "Man stabs and kills worker in Japan and then stabs himself. Coworkers risk their lives by prioritizing evacuating customers.",
    ...
    {
      "happened": "ICE agents are checking IDs at airports using TSA equipment. The actual TSA employees continue to work without pay and the ICE agents salaries are inflated.",
    ...
    {
      "happened": "Sheep are domesticated; PETA has stated that shearing sheep is cruel, but in reality, not shearing them is more cruel because the weight can immobilize them and their wool grows continuously.",
    ...
    {
      "happened": "Julia Angwin, a NYT journalist, is suing Grammarly for suggesting edits using her name because in reality Angwin would not recommend the slop Grammarly is recommending.",
    ...
    {
      "happened": "Cats always fall on their feet because of their flexible spines that help them turn them to look at the ground so they know how to land.",
    ...
    {
      "happened": "Hundreds of flights have been canceled or delayed this week due to TSAs low staffing levels.",
    ...
    {
      "happened": "Luckin Coffee, a Chinese coffee chain, has bought Blue Bottle Coffee but the brands are still expected to perform separately.",
    ...
    {
      "happened": "Consumers are starting to spend less at slop bowl places because the prices are too high due to rising prices in groceries and it's difficult for these food chains to lower the price.",
    ...
    {
      "happened": "Trader Joe's recalled fried rice and dumplings because they contained glass remnants, but luckily no one was hurt.",
    ...
    {
      "happened": "Kristi Noem, previous Secretary of Homeland Security, was fired after spending $220 million on an ad campaign because her answers didn't align with Trump's.",
    ...
    {
      "happened": "Mcdonalds CEO, Chris Kempczinski, tried a new menu item for ad campaign, people commented on his small bite, saying that he doesn't enjoy his own product and Burger King also replied.",
    ...
    {
      "happened": "Dogs are expected to help people live longer because they encourage people to be active and lower people's blood pressure.",
    ...
    {
      "happened": "Tenz and Kyedae, a famous gaming couple mutually broke up after 6-7 years, their breakup gained a lot of speculation and Kyedae received backlash because of their history together.",
    ...
    {
      "happened": "Brady Tkachuk had joked on a phone call with Donald Trump about the US women's hockey team, he addressed the backlash he got from this by saying he was caught off guard, and that he respects the women's team and also mentioned that the offensive remarks are AI generated.",
    ...
    {
      "happened": "Four stories about people navigating social environments and figuring out how to respond in certain situations because communicating what they're thinking is difficult.",
    ...
    {
      "happened": "The housing market crash is starting to have more sellers than buyers, many people in the South are trying to sell their homes but are struggling to find buyers even with cash incentives.",
    ...
    {
      "happened": "Joseph Lynskey was pushed in front of an oncoming 18th St subway in NY 2 years ago and he is just starting to take the subway again.",
    ...
    {
      "happened": "Deliveristas in NY continued to work during Feb 22-23 snow blizzard eventhough some food apps paused service due to the risks.",
    ...
    {
      "happened": "Takahiro Anno's political party, Team Mirai, won 11 seats in the House of Representatives in Tokyo on Feb 8th by campaigning for AI policies like government chatbots and self driving busses to modernize government and address labor shortages.",
    ...
    {
      "happened": "Trump's ICE detention centers could be considered a \"concentration camp\" and these camps exist so they can do things that they wouldn't do out in the open.",
    ...
    {
      "happened": "NYU Langone has stopped providing families with gender related care to adolescents February 18th because of defending threats from the Trump Administration.",
    ...
    {
      "happened": "Draco Malfoy has become the icon of the Lunar New Year 2026 in China because Malfoy transliterates to \"ma er fu\" and horse in Mandarin is \u9a6c (ma).",
    ...
    {
      "happened": "Kevin Durant from NBA Houston Rockets has been accused for the second time to be anonymously badmouthing teammates and coaches on X.",
    ...
    {
      "happened": "Man kills his wife and children at a highschool hockey game and suicides afterwards.",
    ...
    {
      "happened": "Lancome L'Absolu Rogue, MACximal, Dior Addict Hydrating Shine, Revlon Super Lustrous, and Guerlain Rougue G Ultra Care are some of the best lipsticks on the market.",
    ...
    {
      "happened": "People who drink to feel \"fun\" in society often drink more than people who drink solo, it's not good to rely on alcohol and lots of people are able to socialize without drinking alcohol.",
    ...
    {
      "happened": "Repeteaded use of earbuds and earplugs disrupts your ears natural process of shedding and cleaning itself, so it's best to use minimally.",
    ...
    {
      "happened": "Dish soap can remove stains, cut grime and grease on appliances (fridges), and clean jewlery. It's a great multipurpose cleaner because it's safe on skin.",
    ...
    {
      "happened": "George Howell in MA has a specialty coffee thats $24. It is supposed to taste floral and fruit and the price helps give back and recognize farmers.",
    ...
    {
      "happened": "Students from Pine Hill in Westwood MA wrote letters to football player Drake Maye to encourage him during the Superbowl.",
    ...
    {
      "happened": "This article tells Ilia Malinin's story of how he became a figure skater and his amazing ability at quadruple axel.",
    ...
    {
      "happened": "Patriots lost the Super Bowl to the Seahawks due to their really strong defense and Kenneth Walker's (Seahawks RB) ability to break away with the ball.",
    ...
    {
      "happened": "Players sweep the ice in curling to create friction that melts the ice, allowing the curling stone to curl into the path.",
    ...
    {
      "happened": "MAC x Depop collab was poorly executed and people were being really ungrateful and disrespectful in order to the lipsticks they wanted.",
    ...
    {
      "happened": "Homeless people are freezing in the cold and it's disputed whether it's because of the new Mamdani system or not.",
    ...
    {
      "happened": "The snow is really bad in Japan (3 feet), lots of people have died or got injured and homes are getting buried.",
    ...
    {
      "happened": "Tokyo Pizzeria is coming to NY for a 2 day popup, the weather made him concerned tho because it delayed his flight 1+days and the cold weather impacts the yeast in the pizza dough. He uses a special flour thats a combo of other flours, so altho hes shared his recipes before hes never shared his flour mix.",
    ...
    {
      "happened": "Trump appears thousands of times in the Epstein files but he's not going to be convicted of anything because they're from anonymous tips and the info is unconfirmed...but there's other parts that are saying Melania might have emailed Ghislaine Maxwell.",
    ...
    {
      "happened": "Billionaires and other wealthy/influential people lied about their involvement with Epstein (saying they denied invitations or their relationship was steictly business) and it is revealed on what they actually did with Epstein.",
    ...
    {
      "happened": "People in MN are buying red yarn and \"Melt the ICE\" hat pattern to show their alignment against ICE, the community is running out of red yarn and it js shows how everyone is committing together. The history of the pattern is that it was worn by Norwegians \"fighting Nazi occupiers\" so it had great meaning behind it too.",
    ...
    {
      "happened": "This article gives tips on how to restore your sweaters that have pilled, using a sweater shaver is the easiest thing and best for synthetic sweaters (remember to use gently though), but if you have cashmere, merino, or other natural fiber sweaters then they recommend a sweater comb.",
    ...
    {
      "happened": "Be aware of what you eat and try to follow a more plant based diet, avoiding smoked or grilled red meat, and eat less ultraprocessed foods--artificially sweetened foods.",
    ...
    {
      "happened": "Trump said he wants an honest investigation about Alex Pretti's killing in Minneapolis, but also says that carrying a legal gun is not okay. This has caused Chris Madel to step down from running from governor because the Trump Administration crackdown on immigrants is acting \"lawlessly\" and he doesn't want to support that.",
